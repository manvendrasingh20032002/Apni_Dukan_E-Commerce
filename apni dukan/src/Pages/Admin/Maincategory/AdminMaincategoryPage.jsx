            ...
            <div className="container-fluid my-3">
                <div className="row">
                    ...
                    <div className="col-md-9">
                        <h6 className='mybackground text-light text-center p-2 fs-1 mb-3'>Maincategory
                                ...
                                <tbody>
                                    {data.map(item => {
                                        return <tr key={item._id}>
                                            ...
                                            <td><Link to={`/admin/maincategory/update/${item._id}`} className='btn btn-primary mybackground'><i className='bi bi-pencil fs-3'></i></Link></td>
