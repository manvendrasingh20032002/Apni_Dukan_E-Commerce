                        ...
                        <div className="col-lg-6">
                            <div className="faq-accordion accordion accordion-flush" id="accordionFlushExample"
                                ...
                                {FaqStateData?.filter(x => x.status)?.map(item => {
                                    return <div className="faq-item accordion-item" key={item._id}>
                                        <h2 className="accordion-header">
                                            <button className="faq-button accordion-button collapsed" type="button"
                                                data-bs-toggle="collapse" data-bs-target={`#flush-collapse${item._id}`} aria-expanded="false"
                                        ...
                                        <div id={`flush-collapse${item._id}`} className="accordion-collapse collapse"
